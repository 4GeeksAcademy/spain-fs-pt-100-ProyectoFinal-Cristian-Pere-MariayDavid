...
Revision ID: 2249cae85036
Revises: 
Create Date: 2025-06-02 10:38:19.727578
...
def upgrade():
    ...
    sa.Column('experiencia_años', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('fecha_incripcion', sa.DateTime(), nullable=False),
